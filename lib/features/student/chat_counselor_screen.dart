...
class _ChatCounselorScreenState extends State<ChatCounselorScreen> {
  ...
  void initState() {
    ...
    _messages.addAll([
      _ChatMessage(
        text: 'Hi! I wanted to discuss my career options after looking at my test results.',
        isMe: true,
        time: DateTime.now().subtract(const Duration(days: 1, hours: 3)),
      ),
      _ChatMessage(
        text: 'Hello! Sure, I\'d love to help. Your recent scores show strong analytical skills. What areas interest you the most?',
        isMe: false,
        time: DateTime.now().subtract(const Duration(days: 1, hours: 2, minutes: 50)),
      ),
      _ChatMessage(
        text: 'I\'m considering engineering but also interested in design. Not sure which path suits me better.',
        isMe: true,
        time: DateTime.now().subtract(const Duration(days: 1, hours: 2, minutes: 40)),
      ),
      _ChatMessage(
        text: 'That\'s a great combination! Your test results show strong analytical and creative skills. Let\'s schedule a session to explore options that blend both fields.',
        isMe: false,
          ...
          IconButton(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Calling ${widget.counselorName}...')),
              );
            },
          ),
        ],
